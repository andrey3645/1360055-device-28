...
* Наставник: `Андрей Чепулис` (после выбора наставника пропала ссылка на него, по памяти написал имя и фамилию, могу ошибиться).
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/1360055-device-28) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
